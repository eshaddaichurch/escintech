...
class Jemaat_model3 extends CI_Model {

    var $tabelview = 'perpuluhan3';
    var $tabel     = 'perpuluhan3';
    // var $idjemaat = 'idjemaat';

    var $column_order = array(null,'nama','perpuluhan','ucapansyukur','dll','atm','tunai','giro','rk', null );
    var $column_search = array('nama','perpuluhan','ucapansyukur','dll','atm','tunai','giro','rk');
