    ...
    <div class="col-md-12">
      <div class="card" id="cardcontent">
        <div class="card-header">
          <h1 class="card-title">Perpuluhan</h1>
          <a href="<?php echo(site_url('pembangunan/index')) ?>" class=" btn btn-primary btn-lg active float-right"><i class="fa fa-plus-circle"></i> Pembangunan</a>
          <a href="<?php echo(site_url('jemaat/tambah')) ?>" class="btn btn-primary btn-lg active float-right"><i class="fa fa-plus-circle"></i> Persembahan Sosial</a>
        </div>
        <div class="card-body">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $("#table").DataTable({ 
        ...
        "order": [], 
         "ajax": {
            "url": "<?php echo site_url('perpuluhan4/datatablesource')?>",
            "type": "POST"
        },
        "columnDefs": [
