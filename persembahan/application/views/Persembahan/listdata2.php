    ...
    <div class="col-md-12 ">
      ...
      <div class="card" id="cardcontent">
        <div div class="card-header">
          <h1 class="card-title float-right">Perpuluhan 21 Mei 2023</h1>
...
<a href="<?php echo(site_url('sound_system/index')) ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
</div>
</div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $("#table").DataTable({ 
        ...
        "order": [], 
         "ajax": {
            "url": "<?php echo site_url('perpuluhan2/datatablesource')?>",
            "type": "POST"
        },
        "columnDefs": [
