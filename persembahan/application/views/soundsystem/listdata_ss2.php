    ...
    <div class="col-md-12">
      <div class="card" id="cardcontent">
        <div class="card-header">
          <h1 class="card-title float-right">Pers. Soundsystem 21 Mei 2023</h1>
          ...
          <a href="<?php echo(site_url('perpuluhan1/index')) ?>" class=" btn btn-primary btn-lg "><i class="fa fa-plus-circle"></i> Perpuluhan 21 Mei 2023</a> | 
          <a href="<?php echo(site_url('perpuluhan2/index')) ?>" class=" btn btn-primary btn-lg "><i class="fa fa-plus-circle"></i> Perpuluhan 28 Mei 2023</a> | 
          ...
          <a href="<?php echo(site_url('Soundsystem1/index')) ?>" class="btn btn-info btn-lg "><i class="fa fa-plus-circle"></i> Pers. Sound System 18 Mei 2023</a> 
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $("#table").DataTable({ 
        ...
        "order": [], 
         "ajax": {
            "url": "<?php echo site_url('soundsystem2/datatablesource')?>",
            "type": "POST"
        },
        "columnDefs": [
