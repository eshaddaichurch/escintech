    ...
    <div class="col-md-12">
      <div class="card" id="cardcontent">
        <div class="card-header">
          <h1 class="card-title">Pembangunan</h1>
          
          <a href="<?php echo(site_url('sosial/index')) ?>" class="btn btn-primary btn-lg active float-right"><i class="fa fa-plus-circle"></i> Persembahan Sosial</a>
          <a href="<?php echo(site_url('perpuluhan/index')) ?>" class=" btn btn-primary btn-lg active float-right"><i class="fa fa-plus-circle"></i> Perpuluhan</a>
        </div>
        <div class="card-body">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $("#table").DataTable({ 
        ...
        "order": [], 
         "ajax": {
            "url": "<?php echo site_url('pembangunan/datatablesource')?>",
            "type": "POST"
        },
        "columnDefs": [
