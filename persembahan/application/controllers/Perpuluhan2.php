...
class Perpuluhan2 extends CI_Controller {

    public function __construct()
    {
        parent::__construct();
        $this->load->model('Jemaat_model2');
    }
    ...
    public function index()
    {
        ...
        $this->load->view('Perpuluhan/listdata2', $data);
    }   
    ...
    {
        $RsData = $this->Jemaat_model2->get_datatables();
        $no = $_POST['start'];
        $data = array();
        ...
        $output = array(
                        "draw" => $_POST['draw'],
                        "recordsTotal" => $this->Jemaat_model2->count_all(),
                        "recordsFiltered" => $this->Jemaat_model2->count_filtered(),
                        "data" => $data,
                );
