...
class Perpuluhan1 extends CI_Controller {

    public function __construct()
    {
        parent::__construct();
        $this->load->model('Jemaat_model1');
    }
    ...
    public function index()
    {
        ...
        $this->load->view('Perpuluhan/listdata1', $data);
    }   
    ...
    {
        $RsData = $this->Jemaat_model1->get_datatables();
        $no = $_POST['start'];
        $data = array();
        ...
        $output = array(
                        "draw" => $_POST['draw'],
                        "recordsTotal" => $this->Jemaat_model1->count_all(),
                        "recordsFiltered" => $this->Jemaat_model1->count_filtered(),
                        "data" => $data,
                );
    ...
    {
        $idjemaat = $this->encrypt->decode($idjemaat);  
        $rsdata = $this->Jemaat_model1->get_by_id($idjemaat);
        ...
        $hapus = $this->Jemaat_model1->hapus($idjemaat);
        if ($hapus) {       
            $pesan = '<div>
    ...
    {       
        ...
        if ( $idjemaat=='' ) {  
            ...
            $simpan = $this->Jemaat_model1->simpan($data);      
        }else{ 
            ...
            $simpan = $this->Jemaat_model1->update($data, $idjemaat);
        }
    ...
    {
        $idjemaat = $this->input->post('idjemaat');
        $RsData = $this->Jemaat_model1->get_by_id($idjemaat)->row();
    ...
    public function ubahkeluarga($idjemaat)
    {
        ...
        $rowjemaat = $this->Jemaat_model1->get_by_id($idjemaat); 
    ...
    public function simpanubahkeluarga()
    {
        ...
        $simpan = $this->Jemaat_model1->simpanubahkeluarga($idjemaat, $idjemaatfamily, $idhubunganfamily);
        if ($simpan) {
            $pesan = '<div>
                        <div class="alert alert-success alert-dismissable">
                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">x</button>
    ...
    {
        $idjemaat = $this->encrypt->decode($idjemaat);
        $hapus = $this->Jemaat_model1->hapusfamily($idjemaat);
        if ($hapus) {
            $pesan = '<div>
                        <div class="alert alert-success alert-dismissable">
                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">x</button>
