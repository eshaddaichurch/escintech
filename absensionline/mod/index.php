	        		...
	        		<div class="d-table-cell c">
	        			<div class="container">
	        				<div class="row h-100 justify-content-center align-items-center">
	        					<div class="col-lg-5">
	        						<div class="hero-content text-center text-white1">
	        							<p>
	        								<img src="<?php echo $site_url; ?>/content/logo/esclogo.png" class="img-fluid" width="180px">
	        							</p>
	        							<h1 class="text-white1"><?php echo $site_name; ?></h1>
	        							<p>
	        							...
	        							<i aria-hidden="true" class="powered fa fa-check-circle"></i> Powered by ESC Intech
