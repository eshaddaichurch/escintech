...
<script type="text/javascript">
   var result;
    ...
    var arrLocAtas = [-0.048046452136718286, 109.31797627291331];
    var arrLocBawah = [-0.04856799721917358, 109.31848133055564];

        var titikLokasiLogin = latitude.split(",");
        // console.log(titikLokasiLogin);
        // return;

        //lokasi kiri, lokasi kanan
        

        if ( (titikLokasiLogin[0] < arrLocAtas[0] && titikLokasiLogin[0] > arrLocBawah[0]) && (titikLokasiLogin[1]> arrLocAtas[1] && titikLokasiLogin[1] < arrLocBawah[1] ) ) {
            ...
            swal({title: 'Upps', text:'Anda harus absen di lokasi Gereja Elshaddai!', icon: 'error', timer: 3500,});
        }
