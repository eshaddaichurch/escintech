...
class Baptisan_model extends CI_Model
{
    ...
    var $tabelview = 'v_carebaptisan';
    var $tabel     = 'carebaptisan';
    var $idcarebaptisan = 'idcarebaptisan';
    ...
    var $order = array('idcarebaptisan' => 'desc'); // default order 
    ...
    public function get_by_id($idcarebaptisan)
    {
