...
class Disciplescommunity_model extends CI_Model {
    ...
    var $column_order = array(null,'iddc','namadc','namadm','kategoridc','haridc','jamdc','alamatdc','tanggalinsert','tanggalupdate','statusaktif' ,null );
    var $column_search = array('iddc','namadc','namadm','kategoridc','haridc','jamdc','alamatdc');
