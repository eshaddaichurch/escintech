                                    ...
                                    <div class="col-md-4 text-lg">
                                      ...
                                      <div class="card">
                                        <div class="card-body">
                                          ...
                                          <div class="form-check mt-3">
                                            <input class="form-check-input" type="radio" name="jenisjadwal" id="exampleRadios4" value="Kelas">
...
<?php $this->load->view('penjadwalan/modalkelengkapan'); ?>
<?php $this->load->view('penjadwalan/modalwaktudantempat'); ?>
...
$('input[type=radio][name=jenisjadwal]').change();
    ...
    table = $('#table').DataTable({ 
        ...
        "bInfo" : false, 
         "ajax"  : {
                  "url": "<?php echo site_url('penjadwalan/datatablejadwalevendetail')?>",
                  "dataType": "json",
                  "type": "POST",
  ...
  function onFinish() {
    ...
    var formData = {
      ...
      $.ajax({
                type        : 'POST', 
                url         : '<?php echo site_url("penjadwalan/simpanjadwalevent") ?>', 
                data        : formData, 
                dataType    : 'json', 
                encode      : true
            })
            .done(function(simpanjadwaleventResult){
                ...
                if (simpanjadwaleventResult.success) {
                    ...
                    .then((willDelete) => {
                      window.location.href = "<?php echo(site_url('penjadwalan')) ?>";
                    });
