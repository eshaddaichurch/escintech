                  ...
                  <div class="col-4">
                    ...
                    <div class="card">
                      <div class="card-body card-event shadow">
                        ...
                        <h3 class="text-gray">Informasi Jadwal Event</h3><hr>                    
                        <div class="row">
                          <div class="col-md-12">
                            <?php 
                  ...
                  <div class="col-4">
                    ...
                    <div class="card">
                      <div class="card-body card-event shadow">
                        ...
                        <h3 class="text-gray">Kelengkapan Event</h3><hr>                    
                        <div class="row">
                          <div class="col-md-12">
                            <?php 
                              $pesan = $this->session->flashdata("pesan");
                  ...
                  <div class="col-4">
                    ...
                    <div class="card">
                      <div class="card-body card-event shadow">
                        ...
                        <h3 class="text-gray">Informasi Lainnya</h3><hr>                    
                        <div class="row">
                          <div class="col-md-12">
                            <?php 
                              $pesan = $this->session->flashdata("pesan");
                          ...
                          <div class="col-12">
                              ...
                              <?php  if ($rowPengajuan->diumumkankejemaat=='Ya') { ?>
                                  <h3 class="text-gray">Diumumkan Ke Jemaat</h3><hr>                    
                                  <table class="table">
                              ...
                              <?php  if ($rowPengajuan->tampilkandiwebsite=='Ya') { 
                                ...
                                ?>
                                  <h3 class="text-gray"> <i class="fa fa-check"></i> Tampilkan Di Website</h3><hr>                    
                                  <table class="table">
...
<script type="text/javascript">
  ...
  function simpan(status) {
    ...
    $.ajax({
      ...
      type: 'POST',
      dataType: 'json',
      data: {'idjadwalevent': idjadwalevent, 'status': status, 'keterangankonfirmasi': keterangankonfirmasi},
    })
