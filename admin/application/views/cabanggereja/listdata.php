  ...
  <div class="row" id="toni-breadcrumb">
    ...
    <div class="col-6">
      <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active">Cabang Gereja</li>
      </ol>
    ...
    <div class="col-md-12">
      <div class="card" id="cardcontent">
        <div class="card-header">
          <h5 class="card-title">List Data Cabang Gereja Elshaddai</h5>
          <a href="<?php echo(site_url('cabanggereja/tambah')) ?>" class="btn btn-sm btn-primary float-right"><i class="fa fa-plus-circle"></i> Tambah Data</a>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-bordered table-striped table-condesed" id="table">
                  <thead>
                    <tr class="bg-primary" style="">
                      ...
                      <th style="width: 15%; text-align: center;">Latitude<br>Longitude</th>
