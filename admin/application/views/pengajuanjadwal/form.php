                 ...
                 <div id="smartwizard">
                   ...
                   <div class="tab-content">
                     ...
                     <div id="step-3" class="tab-pane" role="tabpanel">
                       ...
                       <div class="row">
                         <div class="col-12">
                           <h4 class="text-gray">Tempat dan Tanggal Pelaksanaan Event <a href="#" class="ml-3" id="btnWaktuDanTempat"><i class="fa fa-plus-circle"></i></a></h4>
                           <hr>
                         </div>
                                     ...
                                     <div class="col-12 mt-3">
                                       <div class="card">
                                         <div class="card-body shadow-sm">
                                           <div class="row">
                                             <div class="col-12">
                                               <h5><i class="fas fa-chevron-right"></i> Ruangan Yang Diperlukan? <a href="#" class="ml-3" id="btnRuanganYangDiperlukan"><i class="fa fa-plus-circle"></i></a></h5>
                                             </div>
                                             <div class="col-12">
   ...
   $(document).ready(function() {
     ...
     table = $('#table').DataTable({
       ...
       "ajax": {
         ...
         "type": "POST",
         "data": {
           "idjadwalevent": '<?php echo ($idjadwalevent) ?>'
         }
       },
       "columnDefs": [{
           "targets": [0],
