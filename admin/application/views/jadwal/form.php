...
<div class="row" id="toni-breadcrumb">
    <div class="col-6">
        <h4 class="text-dark mt-2">Jadwalibadah</h4>
    </div>  
    <div class="col-6">
      <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="<?php echo(site_url()) ?>">Home</a></li>
        <li class="breadcrumb-item"><a href="<?php echo(site_url('Jadwalibadah')) ?>">jadwalibadah</a></li>
  ...
  <div class="row" id="toni-content">
    <div class="col-md-12">
      ...
      <form action="<?php echo(site_url('Jadwalibadah/simpan')) ?>" method="post" id="form">                      
        <div class="row">
          <div class="col-md-12">
            <div class="card" id="cardcontent">
              <div class="card-body">
                  ...
                  <input type="hidden" name="idpengkhotbah" id="idpengkhotbah">                      
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <select name="idpengkhotbah" id="idpengkhotbah" class="form-control select2">
                        ...
                        <?php  
                          $rspengkhotbah = $this->db->query("select * from pengkhotbah order by namalengkap");
                          if ($rspengkhotbah->num_rows()>0) {
                            foreach ($rspengkhotbah->result() as $rowpengkhotbah) {
                              echo '
                                <option value="'.$rowpengkhotbah->idpengkhotbah.'">'.$rowpengkhotbah->namalengkap.'</option>
                              ';
                            }
                          }
                        ?>
              ...
              <div class="card-footer">
                ...
                <a href="<?php echo(site_url('jadwalibadah')) ?>" class="btn btn-default float-right mr-1 ml-1"><i class="fa fa-chevron-circle-left"></i> Kembali</a>
              </div>
            </div> <!-- /.card -->
          </div> <!-- /.col -->
        </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    if ( idjadwalibadahmingguan != "" ) {  //edit (ada isi idjadwalibadahmingguan)
          ...
          $.ajax({
              type        : 'POST', 
              url         : '<?php echo site_url("Jadwalibadah/get_edit_data") ?>', 
