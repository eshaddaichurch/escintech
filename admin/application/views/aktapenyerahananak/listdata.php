  ...
  <div class="row" id="toni-breadcrumb">
    ...
    <div class="col-6">
      <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active">Akta Penyerahan Anak</li>
      </ol>
    ...
    <div class="col-md-12">
      <div class="card" id="cardcontent">
        <div class="card-header">
          <h5 class="card-title">List Data Akta Penyerahan Anak</h5>
          <a href="<?php echo(site_url('aktapenyerahananak/tambah')) ?>" class="btn btn-sm btn-primary float-right"><i class="fa fa-plus-circle"></i> Tambah Data</a>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-md-12">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $("#table").DataTable({ 
        ...
        "order": [], 
         "ajax": {
            "url": "<?php echo site_url('aktapenyerahananak/datatablesource')?>",
            "type": "POST"
        },
        "columnDefs": [
