    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <div class="d-flex">
                    <p class="d-flex flex-column">
                        <span class="text-bold text-lg">Grade 1: <i class="fa fa-user-friends text-success"></i> <span id="totalsiswa5">0</span></span>
                        <span>12 Bulan Terakhir</span>
                    </p>
                </div>
                <div class="position-relative mb-4">
                    <canvas id="visitors-chart5" height="200"></canvas>
                </div>
                <div class="d-flex flex-row justify-content-end">
                    <span class="mr-2">
                        <i class="fas fa-square text-primary"></i> Jumlah Jemaat
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <div class="d-flex">
                    <p class="d-flex flex-column">
                        <span class="text-bold text-lg">Grade 2: <i class="fa fa-user-friends text-success"></i> <span id="totalsiswa6">0</span></span>
                        <span>12 Bulan Terakhir</span>
                    </p>
                </div>
                <div class="position-relative mb-4">
                    <canvas id="visitors-chart6" height="200"></canvas>
                </div>
                <div class="d-flex flex-row justify-content-end">
                    <span class="mr-2">
                        <i class="fas fa-square text-primary"></i> Jumlah Jemaat
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <div class="d-flex">
                    <p class="d-flex flex-column">
                        <span class="text-bold text-lg">Grade 3: <i class="fa fa-user-friends text-success"></i> <span id="totalsiswa7">0</span></span>
                        <span>12 Bulan Terakhir</span>
                    </p>
                </div>
                <div class="position-relative mb-4">
                    <canvas id="visitors-chart7" height="200"></canvas>
                </div>
                <div class="d-flex flex-row justify-content-end">
                    <span class="mr-2">
                        <i class="fas fa-square text-primary"></i> Jumlah Jemaat
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <div class="d-flex">
                    <p class="d-flex flex-column">
                        <span class="text-bold text-lg">Folunteer: <i class="fa fa-user-friends text-success"></i> <span id="totalsiswa8">0</span></span>
                        <span>12 Bulan Terakhir</span>
                    </p>
                </div>
                <div class="position-relative mb-4">
                    <canvas id="visitors-chart8" height="200"></canvas>
                </div>
                <div class="d-flex flex-row justify-content-end">
                    <span class="mr-2">
                        <i class="fas fa-square text-primary"></i> Jumlah Jemaat
...
<script>
    ...
    $(function() {
        ...
        $.ajax({
                url: '<?php echo site_url("dashboardnextstep/getgrafikgrade1") ?>',
                type: 'GET',
                dataType: 'json',
            })
            .done(function(resultgrafikhit) {
                console.log('yg ini');
                console.log(resultgrafikhit);
                $('#totalsiswa5').html(resultgrafikhit.totalsiswa);
                var $visitorsChart = $('#visitors-chart5')
                var visitorsChart = new Chart($visitorsChart, {
                    data: {
                        labels: resultgrafikhit.datatanggal,
                        datasets: [{
        ...
        $.ajax({
                url: '<?php echo site_url("dashboardnextstep/getgrafikgrade2") ?>',
                type: 'GET',
                dataType: 'json',
            })
            .done(function(resultgrafikhit) {
                console.log('yg ini');
                console.log(resultgrafikhit);
                $('#totalsiswa6').html(resultgrafikhit.totalsiswa);
                var $visitorsChart = $('#visitors-chart6')
                var visitorsChart = new Chart($visitorsChart, {
                    data: {
                        labels: resultgrafikhit.datatanggal,
                        datasets: [{
        ...
        $.ajax({
                url: '<?php echo site_url("dashboardnextstep/getgrafikgrade3") ?>',
                type: 'GET',
                dataType: 'json',
            })
            .done(function(resultgrafikhit) {
                console.log('yg ini');
                console.log(resultgrafikhit);
                $('#totalsiswa7').html(resultgrafikhit.totalsiswa);
                var $visitorsChart = $('#visitors-chart7')
                var visitorsChart = new Chart($visitorsChart, {
                    data: {
                        labels: resultgrafikhit.datatanggal,
                        datasets: [{
        ...
        $.ajax({
                url: '<?php echo site_url("dashboardnextstep/getgrafikfolunteer") ?>',
                type: 'GET',
                dataType: 'json',
            })
            .done(function(resultgrafikhit) {
                console.log('yg ini');
                console.log(resultgrafikhit);
                $('#totalsiswa8').html(resultgrafikhit.totalsiswa);
                var $visitorsChart = $('#visitors-chart8')
                var visitorsChart = new Chart($visitorsChart, {
                    data: {
                        labels: resultgrafikhit.datatanggal,
                        datasets: [{
