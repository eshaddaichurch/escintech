 ...
 <script type="text/javascript">
     ...
     if (idregistrasikelas != "") {
       $.ajax({
         ...
         .done(function(result) {
           ...
           $("#idregistrasijadwal").val(result.idregistrasijadwal);
   ...
   $(document).on('change', '#idregistrasijadwal', function() {
     var idregistrasijadwal = $('#idregistrasijadwal').val();

     $.ajax({
         url: '<?= site_url('registrasikelas/getJadwalEvent') ?>',
         type: 'GET',
         dataType: 'json',
         data: {
       ...
       .done(function(responsegetJadwalEvent) {

         //  console.log(responsegetJadwalEvent);
         $('#idjemaat').val(responsegetJadwalEvent[0]['idjemaat']);
         $('#idjadwalevent').val(responsegetJadwalEvent[0]['idjadwalevent']);
       })
       .fail(function() {
