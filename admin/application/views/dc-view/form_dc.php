...
<div class="row" id="toni-breadcrumb">
    <div class="col-6">
        <h4 class="text-dark mt-2">Daftar DC</h4>
    </div>
    <div class="col-6">
            ...
            <div class="card" id="cardcontent">
                <div class="card-header">
                  ...
                  <div class="form-group row">
                    <label for="" class="col-md-3 col-form-label">ID DC</label>
                    <div class="col-md-9">
                      <input type="text" name="iddc" id="iddc" class="form-control" placeholder="Auto" readonly="">
                    </div>
                  </div>
                  ...
                  <div class="form-group row required">
                    <label for="" class="col-md-3 col-form-label">Jam DC</label>
                    <div class="col-md-3">
                  ...
                  <div class="form-group row ">
                    <label for="" class="col-md-3 col-form-label">Alamat DC</label>
                    <div class="col-md-6">
                      <textarea name="alamatdc" id="alamatdc" class="form-control" rows="4" placeholder="Masukkan alamat DC"></textarea>
                    </div>
                  </div>

                  <div class="form-group row">
                    <label for="" class="col-md-3 col-form-label">Foto DC</label>
                    <div class="col-md-9">
                      <input type="file" name="fotodc" value="">
                      <input type="hidden" name="fotodc_lama" id="fotodc_lama" value="">
                      <br>
                      <a href="" id="fotodclink" target="_blank"></a>
                    </div>
                  </div>
