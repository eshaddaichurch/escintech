...
<div class="row" id="toni-breadcrumb">
    <div class="col-6">
        <h4 class="text-dark mt-2">Disciplescimmunity</h4>
    </div>
    <div class="col-6">
      <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="<?php echo(site_url()) ?>">Home</a></li>
        <li class="breadcrumb-item"><a href="<?php echo(site_url('Disciplescommunity')) ?>">DC</a></li>
  ...
  <div class="row" id="toni-content">
    <div class="col-md-12">
      ...
      <form action="<?php echo(site_url('Disciplescommunity/simpan')) ?>" method="post" id="form">
        <div class="row">
          <div class="col-md-12">
            <div class="card" id="cardcontent">
              <div class="card-body">
                  ...
                  <h3 class="text-gray">Data Disciples Community</h3><hr>

                  <input type="hidden" name="iddc" id="iddc">
                  <div class="form-group row">
                    <label for="" class="col-md-3 col-form-label">Nama DC</label>
                    <div class="col-md-9">
                      <input type="text" name="namadc" id="namadc" class="form-control" placeholder="Auto" readonly="">
                    </div>
                  </div>
                  <div class="form-group row required">
                    <label for="" class="col-md-3 col-form-label">Kategori DC</label>
                    <div class="col-md-3">
                      <input type="text" name="kategoridc" id="kategoridc" class="form-control" placeholder="Masukkan kategoridc">
                    </div>
                  </div>
                  <div class="form-group row required">
