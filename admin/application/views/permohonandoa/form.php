...
<div class="row" id="toni-breadcrumb">
    <div class="col-6">
        <h4 class="text-dark mt-2">Permohonan Doa</h4>
    </div>
    <div class="col-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?php echo (site_url()) ?>">Home</a></li>
            <li class="breadcrumb-item"><a href="<?php echo (site_url('permohonandoa')) ?>">Permohonan Doa</a></li>
                ...
                <div class="col-md-12">
                    <div class="card" id="cardcontent">
                        <div class="card-body">
                            ...
                            <input type="hidden" name="idpermohonan" id="idpermohonan" value="<?php echo $rowKonseling->idpermohonan ?>">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="<?php echo (site_url('permohonandoa')) ?>" class="btn btn-default float-right mr-1 ml-1"><i class="fa fa-chevron-circle-left"></i> Kembali</a>
                        </div>
                    </div> <!-- /.card -->
                </div> <!-- /.col -->
            </div>
