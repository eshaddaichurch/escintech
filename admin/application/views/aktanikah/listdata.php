    ...
    <div class="col-md-12">
      <div class="card" id="cardcontent">
        <div class="card-header">
          <h5 class="card-title">List Data Akta Nikah</h5>
          <a href="<?php echo(site_url('aktanikah/tambah')) ?>" class="btn btn-sm btn-primary float-right"><i class="fa fa-plus-circle"></i> Tambah Data</a>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-bordered table-striped table-condesed" id="table">
                  <thead>
                    <tr class="bg-primary" style="">
                      ...
                      <th style="text-align: center;">Nama<br>Pengantin Pria</th>
                      <th style="text-align: center;">Nama<br>Pengantin Wanita</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $("#table").DataTable({ 
        ...
        "order": [], 
         "ajax": {
            "url": "<?php echo site_url('aktanikah/datatablesource')?>",
            "type": "POST"
        },
        "columnDefs": [
