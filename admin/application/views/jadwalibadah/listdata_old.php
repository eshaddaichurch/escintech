    ...
    <div class="col-md-12">
      <div class="card" id="cardcontent">
        <div class="card-header">
          <h5 class="card-title">List Jadwal Ibadah</h5>
                ...
                <table class="table table-bordered table-striped table-condesed" id="table">
                  <thead>
                    <tr class="bg-primary" style="">
                      ...
                      <th style="text-align: center;">Id Jadwal Ibadah Mingguan</th>
                      <th style="text-align: center;">Tanggal Jadwal</th>
                      <th style="text-align: center;">Tema</th>
                      <th style="text-align: center;">Subtema</th>
                      <th style="text-align: center;">ID Pengkotbah</th>
                      <th style="text-align: center;">Videoembed</th>
                      <th style="text-align: center;">Gambarsampul</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $("#table").DataTable({ 
        ...
        "order": [], 
         "ajax": {
            "url": "<?php echo site_url('Jadwalibadah/datatablesource')?>",
            "type": "POST"
        },
        "columnDefs": [
