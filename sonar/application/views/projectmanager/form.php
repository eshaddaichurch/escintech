...
<div class="row" id="toni-breadcrumb">
    <div class="col-6">
        <h4 class="text-dark mt-2">Project Manager</h4>
    </div>  
    <div class="col-6">
      <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="<?php echo(site_url()) ?>">Home</a></li>
        <li class="breadcrumb-item"><a href="<?php echo(site_url('projectmanager')) ?>">Project Manager</a></li>
  ...
  <div class="row" id="toni-content">
    <div class="col-md-12">
      <form action="<?php echo(site_url('projectmanager/simpan')) ?>" method="post" id="form" enctype="multipart/form-data">                      
        <div class="row">
          <div class="col-md-12">
            <div class="card" id="cardcontent">
              ...
              <div class="card-body">
                  ...
                  <input type="hidden" name="idprojectmanager" id="idprojectmanager">                      
              ...
              <div class="card-footer">
                ...
                <a href="<?php echo(site_url('projectmanager')) ?>" class="btn btn-default float-right mr-1 ml-1"><i class="fa fa-chevron-circle-left"></i> Kembali</a>
              </div>
            </div> <!-- /.card -->
          </div> <!-- /.col -->
        </div>
...
<script type="text/javascript">
  ...
  var idprojectmanager = "<?php echo($idprojectmanager) ?>";
  ...
  $(document).ready(function() {
    ...
    if ( idprojectmanager != "" ) { 
          $.ajax({
              type        : 'POST', 
              url         : '<?php echo site_url("projectmanager/get_edit_data") ?>', 
          ...
          $("#lbljudul").html("Edit Data Project Manager");
          $("#lblactive").html("Edit");

    }else{
          $("#lbljudul").html("Tambah Data Project Manager");
