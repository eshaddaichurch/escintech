    ...
    <div class="col-md-12">
      <div class="card" id="cardcontent">
        <div class="card-header">
          <h5 class="card-title">List Data Programmer</h5>
          <a href="<?php echo(site_url('programmer/tambah')) ?>" class="btn btn-sm btn-success float-right"><i class="fa fa-plus-circle"></i> Tambah Data</a>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-md-12">
                ...
                <table class="table" id="table" widht="100%">
                  <thead>
                    <tr>
                      ...
                      <th style="text-align: center;">Username/ <br>Email</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $("#table").DataTable({ 
        ...
        "order": [], 
         "ajax": {
            "url": "<?php echo site_url('programmer/datatablesource')?>",
            "type": "POST"
        },
        "columnDefs": [
